    ...
    <>
      {yesPressed ? (
        <div className={"relative"}>
          <img
            className={
              "fixed bottom-10 sm:bottom-12 sm:left-0 left-0 h-48 sm:h-64 lg:h-80 -rotate-12 rounded-md -z-10"
            }
            src={photoboothGif}
          />
          <img
            className={
              "fixed -top-5 sm:top-0 lg:h-96 -right-2 sm:right-0 h-44 lg:right-2 sm:h-72 -rotate-6 rounded-md -z-10"
            }
            src={lean}
          />
          <img
            className={
              "fixed top-0 -left-5 h-36 sm:h-52 lg:h-64 rotate-12 rounded-md -z-10"
            }
            src={lap}
          />
          <img
            className={
              "fixed bottom-5 -right-2 h-52 sm:h-96 lg:h-[26rem] lg:right-2 rotate-6 rounded-md -z-10"
            }
            src={meSelfie}
          />
        </div>
        ...
        <div className={"relative"}>
          <img
            className={
              "fixed bottom-10 left-0 h-40 sm:h-52 lg:h-80 lg:bottom-20 lg:left-5 rotate-12 rounded-md -z-10"
            }
            src={flowers}
          />
          <img
            className={
              "fixed -top-5 left-0 h-40 sm:h-56 lg:h-96 rotate-6 lg:top-0 lg:left-2 rounded-md -z-10"
            }
            src={hug}
          />
          <img
            className={
              "fixed -top-5 -right-2 h-36 sm:h-48 lg:h-80 -rotate-12 lg:top-0 lg:right-5 rounded-md -z-10"
            }
            src={realism}
          />
          <img
            className={
              "fixed bottom-5 right-0 h-52 sm:h-64 lg:h-96 lg:bottom-16 -rotate-6 lg:right-2 rounded-md -z-10"
            }
            src={kiss}
          />
        </div>
      ...
      <div className="flex h-screen flex-col items-center justify-center z-10">
        {yesPressed ? (
          <>
            <img className="-mt-40 -mb-5 h-44 rounded-md" src={jumpingCatGif} />
            <h1 className="my-4 text-2xl sm:text-3xl font-medium text-white">
          ...
          <>
            <img
              ...
              src={beggingCatGif}
            />
            <h1 className="my-4 text-2xl font-medium sm:text-3xl text-white">
      ...
      <footer className="fixed bottom-0 left-0 z-20 w-full p-2 bg-black shadow-sm">
        <span className="text-sm text-white grid grid-cols-2">
          <p className={"text-left col-span-1"}>For Tara 💕</p>
          <p className={"text-right col-span-1"}>Yours forever, Sam 🙆‍♂️</p>
        </span>
      </footer>
    </>
  );
